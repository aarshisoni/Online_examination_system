...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $update_query = "UPDATE admin_register SET fname='$fullname', gender='$gender', dob='$dob', email='$email', branch='$branch', phone='$phone' WHERE teacherid='$teacherid'";
...
<body>
    <div class="container">
        ...
        <?php endif; ?> 
        <p><a href="admin_logout.php"><i class="fas fa-sign-out-alt"></i> Logout</a></p> <!-- Link to logout page -->
    </div>
</body>

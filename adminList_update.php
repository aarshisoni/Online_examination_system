...
if(isset($_POST["update"])){
    ...
    // Update query
    $query = "UPDATE admin_register SET fname='$fname', email='$email', dob='$dob', gender='$gender', branch='$branch', phone='$phone' WHERE teacherid='$teacherid'";
    $data = mysqli_query($con, $query);

    if($data) {
        echo '<script> 
            window.location.href="admin_list.php?teacherid=' . $teacherid . '";  
            alert("Record Updated Successfully!!!");
        </script>';
    } else {
        echo '<script> 
            window.location.href="adminList_update.php?teacherid=' . $teacherid . '";  
            ...
            <table class="Form_table">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="color:gray">
                            <input type="text" name="teacherid" value="<?php echo $teacherid; ?>" readonly>
                        </td>
                    </tr>
                    <tr>

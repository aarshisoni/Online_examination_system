...
// var_dump($studentid); // Debugging statement - Commented out
...
<body>
    <header>
        <div class="menu_bar" id="menuToggle">
            <h3><i class="fas fa-bars"></i>&nbsp;&nbsp;<?php echo $studentName; ?></h3>
            <div class="container">
                <nav class="navbar">
                    <ul class="nav-links">
                        <li class="nav-link">
                            <!-- <a href="student_logout.php"><i class="fas fa-sign-out-alt"></i> Logout</a> -->
                        </li>
                    </ul>
                </nav>
            </div>
    ...
    <div class="student_container" id="studentContainer">
        <div class="side-menu" id="sideMenu">
            <ul>
                <li><a href="#"><a href="student_profile.php?studentid=<?php echo $studentid; ?>"><i class="fas fa-user"></i>&nbsp;<span>My Profile</span></a></li>
                <li><a href="#"><a href="student_quiz_dashboard.php?studentid=<?php echo $studentid; ?>"><i class="fas fa-question-circle"></i>&nbsp;<span>Quiz</span></a></li>
